...
from my_dataset import SegDatset
...
def main():
    ...
    with wandb.init(project='sweep_1', config=config, mode='disabled'):
        ...
        for epoch in range(num_epochs):
            ...
            for idx, (images, masks) in tqdm(enumerate(train_loader), total=len(train_loader)):
                ...
                if ((idx + 1) % 10 )== -1:
                    wandb.log({'train_loss': train_loss/(idx+1)})
